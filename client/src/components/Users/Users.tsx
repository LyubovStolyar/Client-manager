        ...
        return (
            <div className="bg-dark bg-opacity-10 border px-2">
                ...
                }
                {
                    ...
                    <Message type="success" children={`New user: ${this.state.users[this.state.users.length-1].fullName} has added`} />
                }
                {
                    (this.state.deleteSuccess) &&
                    <Message type="success" children={`The user: ${this.state.users[this.state.users.length-1].fullName} was deleted`} />
                }
